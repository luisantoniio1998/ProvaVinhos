...
class AdapterVendas(val fragment: ListaVendasFragment) : RecyclerView.Adapter<AdapterVendas.ViewHolderVenda>() {
    ...
    inner class ViewHolderVenda(itemVenda: View) : RecyclerView.ViewHolder(itemVenda),
        ...
        var venda: Sales? = null
            ...
            set(value: Sales?) {
                ...
                textViewVendaPrecoGarrafa.text = (venda?.precoGarrafa ?: "").toString()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderVenda {
        val itemVenda = fragment.layoutInflater.inflate(R.layout.item_venda, parent, false)
        return ViewHolderVenda(itemVenda)
    }
