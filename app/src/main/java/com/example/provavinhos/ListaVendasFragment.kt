...
class ListaVendasFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private var _binding: FragmentListaVendasBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentListaVendasBinding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        LoaderManager.getInstance(this).initLoader(ID_LOADER_VENDAS, null, this)
    ...
    override fun onCreateLoader(id: Int, args: Bundle?): Loader<Cursor> =
        CursorLoader(
            ...
            null,
            null,
            "${TabelaBDVendas.CAMPO_NOME_CLIENTE}"
        )
    ...
    fun processaOpcaoMenu(item: MenuItem) : Boolean =
        when(item.itemId) {
           ...
           /* R.id.action_alterar -> {
                val acao = ListaVendasFragmentDirections.actionListaVendasFragmentToEditarVendaFragment(vendaSelecionada)
                findNavController().navigate(acao)
                (activity as MainActivity).atualizaTitulo(R.string.inserir_sale_label)
                true
            }
            R.id.action_eliminar -> {
                val acao = ListaVendasFragmentDirections.actionListaVendasFragmentToEliminarVendaFragment(vendaSelecionada!!)
                findNavController().navigate(acao)
                true
            }*/
            else -> false
